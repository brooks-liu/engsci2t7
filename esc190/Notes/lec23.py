################################################################################
# painting houses https://www.cs.toronto.edu/~guerzhoy/190/lec/W10/DynamicProgramming.pdf
...
#if you wanted them to be the same as the diagram, need to move the indicies
...
# R(k) = cost(k, "red") + cost of paint + min(G(k-1), B(k-1))
